      ...
      <div className="p-4">
        <div className="flex items-center justify-between w-full py-2 rounded">
          <input
            type="text"
            placeholder="Filter..."
            className="border text-text placeholder-text border-border text-sm px-3 py-1 rounded w-1/2 focus:outline-none focus:ring-2 "
          />

          <select className="border border-border text-sm px-2 py-1 rounded bg-background">
        ...
        <table className="w-full text-sm border-collapse text-title">
          <thead className="text-left bg-card-bg border-b border-border">
            <tr>
              <th className="p-2">
                <input type="checkbox" />
              </th>
        ...
        <div className="flex items-center justify-between py-3 text-sm text-title">
          ...
          <div className="flex items-center space-x-1">
            <button className="px-2 py-1 border border-border rounded hover:bg-background">
              &lt;
            </button>
            <button className="px-2 py-1 text-text">1</button>
            <button className="px-2 py-1 text-text">2</button>
            <button className="px-2 py-1 text-text">3</button>
            <span className="px-2 py-1 text-text">...</span>
